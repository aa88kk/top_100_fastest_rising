...
| ----- | ------- | ------------- | ------------- |
| 14583 | [go-zero](https://github.com/zeromicro/go-zero) | go-zero is a web and rpc framework written in Go. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity. | 2020-08-07 15:37:57 +0000 UTC |
| 13167 | [algorithm-pattern](https://github.com/greyireland/algorithm-pattern) | 算法模板，最科学的刷题方式，最快速的刷题路径，你值得拥有~ | 2020-06-13 15:29:21 +0000 UTC |
| 7957 | [duf](https://github.com/muesli/duf) | Disk Usage/Free Utility - a better 'df' alternative | 2020-09-20 21:22:38 +0000 UTC |
| 7453 | [Xray-core](https://github.com/XTLS/Xray-core) | Xray, Penetrates Everything. Also the best v2ray-core, with XTLS support. Fully compatible configuration. | 2020-11-09 11:23:10 +0000 UTC |
| 7248 | [go-ibax](https://github.com/IBAX-io/go-ibax) | An innovative Blockchain Protocol Platform, which everyone can deploy their own applications quickly and easily, such as Dapp, DeFi, DAO, Cross-Blockchain transactions, etc.  | 2020-08-27 08:47:55 +0000 UTC |
...
| 6930 | [nuclei](https://github.com/projectdiscovery/nuclei) | Fast and customizable vulnerability scanner based on simple YAML based DSL. | 2020-04-03 18:47:11 +0000 UTC |
...
| 6066 | [Reverse-Engineering](https://github.com/mytechnotalent/Reverse-Engineering) | A FREE comprehensive reverse engineering tutorial covering x86, x64, 32-bit ARM & 64-bit ARM architectures. | 2020-02-14 12:53:45 +0000 UTC |
| 6032 | [earthly](https://github.com/earthly/earthly) | Repeatable builds | 2020-03-12 18:24:04 +0000 UTC |
| 5755 | [bit](https://github.com/chriswalz/bit) | Bit is a modern Git CLI | 2020-09-11 00:50:18 +0000 UTC |
...
| 5754 | [go-admin](https://github.com/go-admin-team/go-admin) | 基于Gin + Vue + Element UI的前后端分离权限管理系统脚手架（包含了：多租户的支持，基础用户管理功能，jwt鉴权，代码生成器，RBAC资源控制，表单构建，定时任务等）3分钟构建自己的中后台项目；文档：https://doc.go-admin.dev   Demo： https://www.go-admin.dev Antd beta版本：https://preview.go-admin.dev | 2020-03-13 09:22:25 +0000 UTC |
| 5574 | [owncast](https://github.com/owncast/owncast) | Take control over your live stream video by running it yourself.  Streaming + chat out of the box. | 2020-05-24 00:58:13 +0000 UTC |
...
| 5281 | [infracost](https://github.com/infracost/infracost) | Cloud cost estimates for Terraform in pull requests💰📉 Love your cloud bill! | 2020-06-24 09:11:56 +0000 UTC |
| 5269 | [slides](https://github.com/maaslalani/slides) | Terminal based presentation tool | 2021-05-05 23:13:42 +0000 UTC |
| 5184 | [pyroscope](https://github.com/pyroscope-io/pyroscope) | Continuous Profiling Platform!  Debug performance issues down to a single line of code | 2020-12-31 05:47:19 +0000 UTC |
...
| 4848 | [juicefs](https://github.com/juicedata/juicefs) | JuiceFS is a distributed POSIX file system built on top of Redis and S3. | 2021-01-08 09:39:46 +0000 UTC |
...
| 4358 | [k0s](https://github.com/k0sproject/k0s) | k0s - The Zero Friction Kubernetes by Team Lens | 2020-06-10 10:44:09 +0000 UTC |
| 4341 | [waypoint](https://github.com/hashicorp/waypoint) | A tool to build, deploy, and release any application on any platform. | 2020-04-27 03:08:12 +0000 UTC |
...
| 4225 | [trojan-go](https://github.com/p4gefau1t/trojan-go) | Go实现的Trojan代理，支持多路复用/路由功能/CDN中转/Shadowsocks混淆插件，多平台，无依赖。A Trojan proxy written in Go. An unidentifiable mechanism that helps you bypass GFW. https://p4gefau1t.github.io/trojan-go/ | 2020-03-17 16:56:35 +0000 UTC |
